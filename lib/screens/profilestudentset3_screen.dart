...
class ProfileStudentStep3Screen extends StatefulWidget {
  ...
  @override
  State<ProfileStudentStep3Screen> createState() => _ProfileStudentStep3ScreenState();
}
              ...
              DottedBorder(
                ...
                child: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        Icon(Icons.upload_file,size: 90,color: Colors.white,),
                        // CustomText(text: "Drag on",isBold: true,),
                        CustomButton(onPressed: (){pickFile(context);} , text: "choose file to up",)  
                      ],
                    ),
                ),
              ),
