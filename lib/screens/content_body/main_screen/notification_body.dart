              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    CustomText(
                      text:
                          "You have submitted to join project 'Jarvis-AI Copilot'",
                      isBold: true,
                    ),
                    SizedBox(
                      height: 12,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    CustomText(
                      text:
                          "You have invited to interview for project 'Jarvis-AI Copilot' at 14:00 March 20, Thursday",
                      isBold: true,
                    ),
                    SizedBox(
                      height: 12,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    CustomText(
                      text:
                          "You have offered to join project 'Jarvis-AI Copilot'",
                      isBold: true,
                    ),
                    SizedBox(
                      height: 12,
