      ...
      body:  InitialBody(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
            const Center(child: CustomText(text: "Welcome to Student Hub",isBold: true)),
            const SizedBox(
                height: SpacingUtil.smallHeight,
              ),
            const CustomText(text: "Tell us about your company and you will be on your way connect with high-skilled student"),
            const SizedBox(
                height: SpacingUtil.smallHeight,
              ),
            const CustomText(text: "How many people are in your company ?"),
              Column(
                ...
                children: [
                 ...
                 chooseNumber(EnumNumberPeople.ten_to_nightynine,"10-99 employees"),
                 chooseNumber(EnumNumberPeople.hundred_to_thousand,"100-1000 employees"),
                 chooseNumber(EnumNumberPeople.more_than_thousand,"more than 1000 emoployees"),
                ]
              ),
              const SizedBox(
                height: SpacingUtil.smallHeight,
              ),
              const CustomText(text: "Company name",isBold: true,),
              const SizedBox(
                height: SpacingUtil.smallHeight,
              ),
              CustomTextfield(controller: companyNameController, hintText: ""),
              const CustomText(text: "website",isBold: true,),
              const SizedBox(
                height: SpacingUtil.smallHeight,
              ),
              CustomTextfield(controller: websiteController, hintText: ""),
              const CustomText(text: "Description",isBold: true,),
              const SizedBox(
                height: SpacingUtil.smallHeight,
              ),
              CustomTextfield(controller: descriptionController, hintText: "",maxLines: 2,),
              const SizedBox(
