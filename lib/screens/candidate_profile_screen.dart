...
class CandidateProfileScreen extends StatefulWidget {
  final String id;
  const CandidateProfileScreen({super.key,required this.id});
...
class _CandidateProfileScreenState extends State<CandidateProfileScreen> {
  ...
  Future<StudentProfile> initializeProfile() async {
    ...
    final response = await ProfileService.getProfileCandidate(id: widget.id, token: token!); 
  ...
  Column profileItem(StudentProfile profile) {
    return Column(
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      CustomText(text: profile.fullname,isBold: true,size: 25,),
                      CustomText(text:profile.techStack.name,size: 22,),                      
                    ],
                  ),
                ),  
              ],
            ...
            const CustomDivider(),
            const CustomText(text: "Communications",isBold: true,size: 19,),
            CustomText(text:'gmail: ${profile.email}', size: 15,),
        
            const CustomDivider(),
            const CustomText(text: "Skills",isBold: true,size: 19,),
            const SizedBox(
              height: 10,
            ),
         
            Container(
                height: profile.skillSets.isNotEmpty ?  profile.skillSets.length * 58.0 : 20,
            ...
            const CustomText(text: "Educations",isBold: true,size: 19,),
            const SizedBox(
              height: 10,
            ),
            
            Container(
              height: profile.educations.isNotEmpty ?  profile.educations.length* 80.0 : 10,
              decoration: decoration(),  
              child: ListView.builder(
            ...
            const CustomText(text: "Experience",isBold: true,size: 19,),
            const SizedBox(
              height: 10,
            ),
            Container(
              padding: const EdgeInsets.all(7.0),
              height: profile.experiences.isNotEmpty ?  profile.experiences.length* 250.0 : 10,
              decoration: decoration(),  
              child: ListView.builder(
          ...
          const CustomText(text: "Language",isBold: true,size: 19,),
          const SizedBox(
            height: 10,
          ),
          Container(
            height: profile.languages.isNotEmpty ?  profile.languages.length* 68.0 : 10,
            decoration: decoration(), 
            child: ListView.builder(
          ...
          const CustomText(text: "Resume",isBold: true,size: 19,),
          const SizedBox(
            height: 10,
          ),
          Container(
            ...
            child:  Row(
              children: [
                Flexible(child: Text(profile.resume,style: textStyleTitle(),)),
              ],
            ),
          ),
          const SizedBox(
          ...
          const CustomText(text: "Transcript",isBold: true,size: 19,),
          const SizedBox(
            height: 10,
          ),
          Container(
            ...
            child:  Row(
              children: [
                Flexible(child: Text(profile.transcript,style: textStyleTitle(),)),
              ],
            ),
          ),
          const SizedBox(
  ...
  TextStyle textStyleSubtitle() => const  TextStyle(fontSize: 17,color:  Colors.black);

  TextStyle textStyleTitle() => const TextStyle(color:  Colors.black,fontSize: 19,fontWeight: FontWeight.w500);

  Icon iconLeading() => const Icon(Icons.arrow_circle_right_outlined,size: 19,color:  Colors.black);
